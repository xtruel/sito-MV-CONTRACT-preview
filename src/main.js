...
const translations = {
    ...
    en: {
        ...
        carpentry_text: "We have a large carpentry workshop with an internal painting room to reduce waiting times and ensure total quality control on every finish.",
