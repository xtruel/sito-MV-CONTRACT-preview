...
const translations = {
    it: {
        ...
        carpentry_lead: "Realizziamo arredi su misura, con particolare attenzione al dettaglio e alla qualità.",
        carpentry_text: "Coordiniamo la realizzazione di arredi su misura e finiture, con particolare attenzione alla qualità e dettaglio. Disponiamo di una nostra falegnameria per la realizzazione di arredi esclusivi.",
        ...
        service1_list: "<li>Preventivazione e pianificazione</li><li>OVS / budgeting</li><li>Acquisti e supply</li><li>Disegno tecnico</li><li>Realizzazione arredi in falegnameria</li><li>Site management, consegna e supporto in garanzia</li>",
        ...
        service2_list: "<li>Assistenza flotte in operatività</li><li>Interventi di refitting</li><li>Forniture e installazioni rapide</li>",
        ...
        portfolio_others: "...e altre realtà del mondo Cruise e Contract",
        ...
        step2_text: "Supply di ogni singolo elemento, disegni per realizzazione e dettaglio tecnico per produzione e cantiere.",
        ...
        step4_text: "Consegna finale nei tempi concordati, con supporto durante il periodo di garanzia del cliente.",
        ...
        sector1_text: "Allestimenti, refit, gestione cantiere, realizzazione e coordinamento forniture.",
        sector2_title: "Yacht",
        sector2_text: "Forniture su misure, installazioni, controllo qualità e consegna puntuale.",
        sector3_title: "Retail",
        sector3_text: "Allestimenti e commesse multi-sito con arredamenti su misura, rapidità e standard elevati.",
        ...
        contact_subtitle: "Per realizzare e gestire i tuoi progetti.",
    ...
    en: {
        ...
        carpentry_text: "We coordinate the creation of custom furniture and finishes, with particular attention to quality and detail. We have our own carpentry workshop for the creation of exclusive furniture.",
        ...
        service1_list: "<li>Estimation and planning</li><li>OVS / budgeting</li><li>Purchasing and supply</li><li>Technical design</li><li>In-house carpentry production</li><li>Site management, delivery and warranty support</li>",
        ...
        service2_list: "<li>Fleet assistance in operation</li><li>Refitting interventions</li><li>Fast supplies and installations</li>",
        ...
        portfolio_others: "...and other entities in the Cruise and Contract world",
        ...
        step2_text: "Supply of every single element, drawings for production and technical detail for site and factory.",
        ...
        step4_text: "Final delivery within the agreed times, with support during the customer's warranty period.",
        ...
        contact_subtitle: "To realize and manage your projects.",
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const switchLang = (lang) => {
        ...
        if (lang === 'it') {
            ...
            langIt.style.display = 'none';
        } else {
            langEn.style.display = 'none';
            langIt.style.display = 'block';
        }
